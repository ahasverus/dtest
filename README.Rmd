...
- [`R/`](https://github.com/ahasverus/dtest/tree/main/R):
...
Launch the [`make.R`](https://github.com/ahasverus/dtest/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ahasverus/dtest/blob/main/CONTRIBUTING.md).
